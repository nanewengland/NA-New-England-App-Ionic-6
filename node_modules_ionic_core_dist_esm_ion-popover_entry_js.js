...
/* harmony import */ var _overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./overlays-5fc09c9a.js */ 7580);
  ...
  switch (triggerAction) {
    case 'hover':
      ...
      triggerCallbacks = [{
        eventName: 'mouseenter',
        callback: function () {
          var _ref = (0,_home_runner_work_NA_New_England_App_Ionic_6_NA_New_England_App_Ionic_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
            ev.stopPropagation();
            if (hoverTimeout) {
...
const configureKeyboardInteraction = popoverEl => {
  const callback = /*#__PURE__*/function () {
    var _ref2 = (0,_home_runner_work_NA_New_England_App_Ionic_6_NA_New_England_App_Ionic_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
      var _a;
...
const Popover = class {
  constructor(hostRef) {
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_6__.B);
    };
  ...
  connectedCallback() {
    ...
    (0,_overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_6__.e)(el);
    configureTriggerInteraction();
  }
  ...
  present(event) {
    ...
    return (0,_home_runner_work_NA_New_England_App_Ionic_6_NA_New_England_App_Ionic_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      return new Promise(resolve => {
         ...
         */
        (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => {
          (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_4__.r)( /*#__PURE__*/(0,_home_runner_work_NA_New_England_App_Ionic_6_NA_New_England_App_Ionic_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
            _this2.currentTransition = (0,_overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_6__.d)(_this2, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, {
            ...
            if (_this2.focusDescendantOnPresent) {
              (0,_overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_6__.j)(_this2.el, _this2.el);
            }
            resolve();
          }));
        });
  ...
  dismiss(data, role, dismissParentPopover = true) {
    ...
    return (0,_home_runner_work_NA_New_England_App_Ionic_6_NA_New_England_App_Ionic_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this3.currentTransition = (0,_overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_6__.f)(_this3, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, _this3.event);
   ...
   */
  onDidDismiss() {
    return (0,_overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_6__.g)(this.el, 'ionPopoverDidDismiss');
  }
  /**
   * Returns a promise that resolves when the popover will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_6__.g)(this.el, 'ionPopoverWillDismiss');
  }
  render() {
