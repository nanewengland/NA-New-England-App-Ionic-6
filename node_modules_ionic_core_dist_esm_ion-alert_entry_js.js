...
/* harmony import */ var _overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./overlays-5fc09c9a.js */ 7580);
/* harmony import */ var _index_eda38007_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index-eda38007.js */ 3148);
...
const Alert = class {
  constructor(hostRef) {
    ...
    this.animated = true;
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_4__.B);
    };
    this.dispatchCancelHandler = ev => {
      const role = ev.detail.role;
      if ((0,_overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_4__.i)(role)) {
  ...
  connectedCallback() {
    (0,_overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_4__.e)(this.el);
  }
  componentWillLoad() {
    this.inputsChanged();
    this.buttonsChanged();
  ...
  componentDidLoad() {
    ...
    this.gesture = (0,_button_active_a4d897e8_js__WEBPACK_IMPORTED_MODULE_3__.c)(this.wrapperEl, refEl => refEl.classList.contains('alert-button'));
   ...
   */
  present() {
    return (0,_overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_4__.d)(this, 'alertEnter', iosEnterAnimation, mdEnterAnimation);
  }
  /**
   ...
   */
  dismiss(data, role) {
    return (0,_overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_4__.f)(this, data, role, 'alertLeave', iosLeaveAnimation, mdLeaveAnimation);
  }
  /**
   * Returns a promise that resolves when the alert did dismiss.
   */
  onDidDismiss() {
    return (0,_overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.el, 'ionAlertDidDismiss');
  }
  /**
   * Returns a promise that resolves when the alert will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.el, 'ionAlertWillDismiss');
  }
  rbClick(selectedInput) {
    ...
    (0,_overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_4__.s)(selectedInput.handler, selectedInput);
  ...
  callButtonHandler(button, data) {
    return (0,_home_runner_work_NA_New_England_App_Ionic_6_NA_New_England_App_Ionic_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button === null || button === void 0 ? void 0 : button.handler) {
        ...
        const returnData = yield (0,_overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_4__.s)(button.handler, data);
        if (returnData === false) {
  ...
  render() {
    ...
    return (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_8e692445_js__WEBPACK_IMPORTED_MODULE_1__.H, Object.assign({
      ...
      id: msgId,
      class: "alert-message",
      innerHTML: (0,_index_eda38007_js__WEBPACK_IMPORTED_MODULE_5__.s)(message)
