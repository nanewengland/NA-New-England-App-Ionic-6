...
/* harmony import */ var _services_tomato_formats_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/tomato-formats.service */ 8135);
...
ModalPage.ctorParameters = () => [{
  ...
  type: _services_tomato_formats_service__WEBPACK_IMPORTED_MODULE_3__.TomatoFormatsService
}, {
...
/***/ 1081:
/*!*************************************************************!*\
  !*** ./src/app/services/service-groups-provider.service.ts ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ServiceGroupsProviderService": () => (/* binding */ ServiceGroupsProviderService)
/* harmony export */ });
...
let ServiceGroupsProviderService = class ServiceGroupsProviderService {
  constructor(http) {
    this.http = http;
    this.getApiUrlServiceGroups = src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_0__.environment.getApiUrlServiceGroups;
  }
  getAllServiceGroups() {
    return this.http.get(this.getApiUrlServiceGroups);
  }
};
ServiceGroupsProviderService.ctorParameters = () => [{
  type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient
}];
ServiceGroupsProviderService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
  providedIn: 'root'
...
/***/ 8135:
/*!****************************************************!*\
  !*** ./src/app/services/tomato-formats.service.ts ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "TomatoFormatsService": () => (/* binding */ TomatoFormatsService)
/* harmony export */ });
...
let TomatoFormatsService = class TomatoFormatsService {
  ...
  setExplodedFormatsOnMeetingList(meetingList, formatLanguage) {
    const uniqueFormatIDs = new Set();
    for (const meeting of meetingList) {
      for (const formatID of (meeting === null || meeting === void 0 ? void 0 : meeting.format_shared_id_list.split(',')) || []) {
    ...
    this.getFormatNamesByID(uniqueFormatIDs, formatLanguage).then(formatNamesByID => {
      ...
      for (const meeting of meetingList) {
        let formats = '';
        for (const formatID of ((_a = meeting === null || meeting === void 0 ? void 0 : meeting.format_shared_id_list) === null || _a === void 0 ? void 0 : _a.split(',')) || []) {
...
TomatoFormatsService.ctorParameters = () => [{
  type: _awesome_cordova_plugins_http_ngx__WEBPACK_IMPORTED_MODULE_0__.HTTP
}];
TomatoFormatsService = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.Injectable)({
  providedIn: 'root'
})], TomatoFormatsService);
...
/* harmony export */ });
/* harmony import */ var _home_runner_work_NA_New_England_App_Ionic_6_NA_New_England_App_Ionic_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_home_runner_work_NA_New_England_App_Ionic_6_NA_New_England_App_Ionic_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
    if (delegate) {
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_home_runner_work_NA_New_England_App_Ionic_6_NA_New_England_App_Ionic_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_home_runner_work_NA_New_England_App_Ionic_6_NA_New_England_App_Ionic_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
