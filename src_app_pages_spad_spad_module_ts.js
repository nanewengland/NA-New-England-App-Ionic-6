...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "#spad-date {\n  text-align: left;\n  font-weight: bold;\n  font-size: x-large;\n  margin-top: 1em;\n}\n\n#spad-title {\n  text-align: center;\n  font-weight: bold;\n  font-size: xx-large;\n  margin-bottom: 1em;\n}\n\n#spad-page {\n  text-align: center;\n  margin-bottom: 1em;\n}\n\n#spad-quote {\n  text-align: left;\n  font-style: italic;\n  margin-bottom: 1em;\n}\n\n#spad-quote-source {\n  text-align: center;\n  margin-bottom: 1em;\n}\n\n#spad-thought {\n  margin-left: 20%;\n  margin-right: 20%;\n  margin-bottom: 2em;\n}\n\n#spad-copyright {\n  font-style: italic;\n  text-align: center;\n  font-size: small;\n  margin-bottom: 1em;\n}\n\nbody {\n  margin: 0 auto;\n  font-family: \"times new roman\", serif;\n}\n\n#spad-container {\n  width: 770px;\n  margin: 0 auto;\n  font-size: medium;\n  font-family: \"times new roman\", serif;\n}\n\n@media (min-width: 750px) and (max-width: 800px) {\n  body {\n    font-size: 13px;\n    font-family: \"times new roman\";\n  }\n  #spad-container {\n    font-size: 13px;\n    width: 85%;\n  }\n  #spad-copyright {\n    font-style: italic;\n    text-align: center;\n    font-size: 11px;\n    margin-bottom: 1em;\n  }\n  #spad-date {\n    text-align: left;\n    font-weight: bold;\n    font-size: 16px;\n    margin-top: 1em;\n  }\n  #spad-title {\n    text-align: center;\n    font-weight: bold;\n    font-size: 18px;\n    margin-bottom: 1em;\n  }\n}\n@media (max-width: 480px) {\n  body {\n    font-size: 9px;\n    font-family: \"times new roman\";\n  }\n  #spad-container {\n    font-size: 9px;\n    width: 85%;\n  }\n  #spad-copyright {\n    font-style: italic;\n    text-align: center;\n    font-size: 7px;\n    margin-bottom: 1em;\n  }\n  #spad-date {\n    text-align: left;\n    font-weight: bold;\n    font-size: 12px;\n    margin-top: 1em;\n  }\n  #spad-title {\n    text-align: center;\n    font-weight: bold;\n    font-size: 14px;\n    margin-bottom: 1em;\n  }\n}", "",{"version":3,"sources":["webpack://./src/app/pages/spad/spad.page.scss"],"names":[],"mappings":"AAAA;EACE,gBAAA;EACA,iBAAA;EACA,kBAAA;EACA,eAAA;AACF;;AAEA;EACE,kBAAA;EACA,iBAAA;EACA,mBAAA;EACA,kBAAA;AACF;;AAEA;EACE,kBAAA;EACA,kBAAA;AACF;;AAEA;EACE,gBAAA;EACA,kBAAA;EACA,kBAAA;AACF;;AAEA;EACE,kBAAA;EACA,kBAAA;AACF;;AAEA;EACE,gBAAA;EACA,iBAAA;EACA,kBAAA;AACF;;AAEA;EACE,kBAAA;EACA,kBAAA;EACA,gBAAA;EACA,kBAAA;AACF;;AAEA;EACE,cAAA;EACA,qCAAA;AACF;;AAEA;EACE,YAAA;EACA,cAAA;EACA,iBAAA;EACA,qCAAA;AACF;;AAEA;EACE;IACE,eAAA;IACA,8BAAA;EACF;EACA;IACE,eAAA;IACA,UAAA;EACF;EACA;IACE,kBAAA;IACA,kBAAA;IACA,eAAA;IACA,kBAAA;EACF;EACA;IACE,gBAAA;IACA,iBAAA;IACA,eAAA;IACA,eAAA;EACF;EACA;IACE,kBAAA;IACA,iBAAA;IACA,eAAA;IACA,kBAAA;EACF;AACF;AAEA;EACE;IACE,cAAA;IACA,8BAAA;EAAF;EAEA;IACE,cAAA;IACA,UAAA;EAAF;EAEA;IACE,kBAAA;IACA,kBAAA;IACA,cAAA;IACA,kBAAA;EAAF;EAEA;IACE,gBAAA;IACA,iBAAA;IACA,eAAA;IACA,eAAA;EAAF;EAEA;IACE,kBAAA;IACA,iBAAA;IACA,eAAA;IACA,kBAAA;EAAF;AACF","sourcesContent":["#spad-date {\n  text-align: left;\n  font-weight: bold;\n  font-size: x-large;\n  margin-top: 1em;\n}\n\n#spad-title {\n  text-align: center;\n  font-weight: bold;\n  font-size: xx-large;\n  margin-bottom: 1em;\n}\n\n#spad-page {\n  text-align: center;\n  margin-bottom: 1em;\n}\n\n#spad-quote {\n  text-align: left;\n  font-style: italic;\n  margin-bottom: 1em;\n}\n\n#spad-quote-source {\n  text-align: center;\n  margin-bottom: 1em;\n}\n\n#spad-thought {\n  margin-left:20%;\n  margin-right: 20%;\n  margin-bottom: 2em;\n}\n\n#spad-copyright {\n  font-style: italic;\n  text-align: center;\n  font-size: small;\n  margin-bottom: 1em;\n}\n\nbody {\n  margin:0 auto;\n  font-family: 'times new roman', serif;\n}\n\n#spad-container {\n  width: 770px;\n  margin:0 auto;\n  font-size: medium;\n  font-family: 'times new roman', serif;\n}\n\n@media (min-width: 750px) and (max-width: 800px) {\n  body {\n    font-size: 13px;\n    font-family: 'times new roman';\n  }\n  #spad-container {\n    font-size: 13px;\n    width: 85%;\n  }\n  #spad-copyright {\n    font-style: italic;\n    text-align: center;\n    font-size: 11px;\n    margin-bottom: 1em;\n  }\n  #spad-date {\n    text-align: left;\n    font-weight: bold;\n    font-size: 16px;\n    margin-top: 1em;\n  }\n  #spad-title {\n    text-align: center;\n    font-weight: bold;\n    font-size: 18px;\n    margin-bottom: 1em;\n  }\n}\n\n@media (max-width: 480px) {\n  body {\n    font-size: 9px;\n    font-family: 'times new roman';\n  }\n  #spad-container {\n    font-size: 9px;\n    width: 85%;\n  }\n  #spad-copyright {\n    font-style: italic;\n    text-align: center;\n    font-size: 7px;\n    margin-bottom: 1em;\n  }\n  #spad-date {\n    text-align: left;\n    font-weight: bold;\n    font-size: 12px;\n    margin-top: 1em;\n  }\n  #spad-title {\n    text-align: center;\n    font-weight: bold;\n    font-size: 14px;\n    margin-bottom: 1em;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
