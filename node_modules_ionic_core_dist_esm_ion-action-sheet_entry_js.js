...
const ActionSheet = class {
   ...
   */
  present() {
    return (0,_overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_4__.d)(this, 'actionSheetEnter', iosEnterAnimation, mdEnterAnimation);
  }
  connectedCallback() {
   ...
   */
  dismiss(data, role) {
    return (0,_overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_4__.f)(this, data, role, 'actionSheetLeave', iosLeaveAnimation, mdLeaveAnimation);
  }
  /**
   * Returns a promise that resolves when the action sheet did dismiss.
   */
  onDidDismiss() {
    return (0,_overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.el, 'ionActionSheetDidDismiss');
  }
  /**
   ...
   */
  onWillDismiss() {
    return (0,_overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.el, 'ionActionSheetWillDismiss');
  }
  buttonClick(button) {
    var _this = this;
  ...
  callButtonHandler(button) {
    return (0,_home_runner_work_NA_New_England_App_Ionic_6_NA_New_England_App_Ionic_6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button) {
        ...
        const rtn = yield (0,_overlays_5fc09c9a_js__WEBPACK_IMPORTED_MODULE_4__.s)(button.handler);
        if (rtn === false) {
